  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          "group/drawer-content bg-beige-50 fixed z-50 flex h-auto flex-col shadow-soft-lg border-beige-200",
        ...
        {...props}
      >
        <div className="bg-beige-100 mx-auto mt-4 hidden h-2 w-[100px] shrink-0 rounded-full group-data-[vaul-drawer-direction=bottom]/drawer-content:block" />
        {children}
      </DrawerPrimitive.Content>
    </DrawerPortal>
  )
...
function DrawerTitle({
  ...
  return (
    <DrawerPrimitive.Title
      ...
      className={cn("text-neutral-800 font-semibold", className)}
      {...props}
    />
  )
}
