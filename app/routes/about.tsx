            ...
            <section className="relative overflow-hidden bg-gradient-to-br from-primary/10 via-accent/10 to-secondary/20">
                ...
                <div className="relative max-w-7xl mx-auto px-6 sm:px-8 py-24">
                    <div className="text-center">
                        <h1 className="text-4xl sm:text-5xl font-semibold text-foreground/80 mb-6">
                            Professional
            ...
            <section className="py-24">
                <div className="max-w-7xl mx-auto px-6 sm:px-8">
                    ...
                    <div className="bg-secondary/30 rounded-2xl p-8">
                        <h3 className="text-2xl font-semibold text-foreground/80 mb-6 text-center">Technical Specifications</h3>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div>
                                <h4 className="text-lg font-semibold text-foreground/80 mb-4 flex items-center gap-2">
            ...
            <section className="py-24">
                <div className="max-w-4xl mx-auto px-6 sm:px-8 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        ...
                        <Link
                            to="/contact"
                            className="border-2 border-primary/20 text-foreground/80 px-8 py-4 rounded-xl font-semibold hover:border-primary/40 hover:bg-primary/5 transition-all duration-300"
                        >
                            Request Quote
                        </Link>
                    </div>
